...
from ...tools.bitbucket import get_workspace_info, get_repository_info, get_commits, get_all_branches, get_all_repositories
...
class BitbucketAgent(BaseAgent):
    ...
    def get_tools(self):
        ...
        return [get_workspace_info_tool, get_repository_info_tool, get_commits_tool, get_all_branches_tool, get_all_repositories_tool]